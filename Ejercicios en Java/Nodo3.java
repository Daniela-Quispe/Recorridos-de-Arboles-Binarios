...
class Main3 {
    ...
    // Funcion para contar la cantidad total de nodos del arbol
    public static int contarNodos(Nodo raiz) {
        if (raiz == null) return 0; // Caso base
        return 1 + contarNodos(raiz.izquierda) + contarNodos(raiz.derecha); // Contar nodos de izquierda y derecha
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nTotal de nodos: " + contarNodos(raiz)); // Muestra el total de nodos del arbol
    }
}